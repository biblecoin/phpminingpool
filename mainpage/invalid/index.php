...
<body class="blog-home-page">   
    ...
    <section class="contact-section section">
        <div class="container">
            <h2 class="title text-center"><br>Invalid shares ?</h2>
            ...
            <form id="contact-form" class="contact-form form" method="post" action="push.php">                    
                <div class="row text-left">
                    <div class="contact-form-inner col-md-8 col-sm-12 col-xs-12 col-md-offset-2 col-sm-offset-0 xs-offset-0">
                        <div class="row"> 
                                If you get any invalid shares it means you may have few ethminer windows or even rigs with the same hashrate, if yes dont use the same value in mining address.<br>For example you have two miners with 60MHash, you need to put 61@ADDRESS and 60@ADDRESS.<br>Hashrate is mainfactor to generate shares with unique difficulity, it's also internal indentifier regarding miners on your address. <br>If you misconfigured it, some shares may get rejected. But if you still getting invalid shares even if you have valid settings, and you are not trying to lower target in ethminer to cheat us. <br>Then just contact us!                                                                                     
