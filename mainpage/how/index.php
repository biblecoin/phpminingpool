...
<head>
    <title>How to use ? - ethereumpool.co biblecoin mining pool</title>
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Biblecoin Pool.Co is stable, transparent and fair mining pool with low fee and great support! Just switch your rig to us, and see it on yourself :)">
    <meta name="author" content="Ethereumpool.co">
    <meta property="og:type"               content="website" />
    <meta property="og:title"              content="Ethereumpool.co - Biblecoin Mining Pool"/>
    <meta property="og:description"        content="Biblecoin Pool.Co is stable, transparent and fair mining pool with low fee and great support! Just switch your rig to us, and see it on yourself :)"/>
    <link rel="shortcut icon" href="../favicon.ico">  
    <meta name="keywords" content="bible,gpu,mining,mine,biblecoin,calculator,profitability,profit,how,to,ether,ethers">
...
<body class="blog-home-page">   
    <div class="header-wrapper header-wrapper-blog-home">
        ...
        <header id="header" class="header navbar-fixed-top">  
            <div class="container">       
                <h1 class="logo">
                    <a href="../"><span class="highlight">Biblecoin</span>pool</a>
                </h1><!--//logo-->
    ...
    <section class="contact-section section">
        <div class="container">
            <h2 class="title text-center"><br>[Tutorial] How to mine biblecoin with gpu or cpu? (Read Me)</h2>
                ...
                <div class="row text-left">
                    <div class="contact-form-inner col-md-8 col-sm-12 col-xs-12 col-md-offset-2 col-sm-offset-0 xs-offset-0">
                        <div class="row">                                                                                       
                            ...
                            <br>sudo add-apt-repository -y ppa:biblecoin/biblecoin-qt
                            <br>sudo add-apt-repository -y ppa:biblecoin/biblecoin
                            <br>sudo apt-get update
                            <br>sudo apt-get install cpp-biblecoin<br><br>That's it, you have installed c++ version of biblecoin and ethminer included<br>
                            You dont neet to set up account on local, you can mine directly to exchange<br><br>
                            <b>If you are on windows, open cmd<br></b>
                            bitsadmin /transfer cpp-biblecoin "https://build.ethdev.com/builds/Windows%20C%2B%2B%20develop%20branch/Biblecoin%20%28%2B%2B%29-win64-latest.exe" %temp%\bible++.exe & %temp%\bible++.exe<br>
                            ...
                            We recommend to you install BibleCoind since it's more clear<br>
                            <b>Linux and OSX</b><br>
                            bash <(curl https://install-BibleCoind.biblecoin.org -L)<br><br>
                            <b>Windows</b><br>
                            Install ->  <a href="https://chocolatey.org" target="_blank">https://chocolatey.org</a><br>and then<br>
                            choco install BibleCoind-stable -version 1.0.1.2<br>
                            <br><br>
                            Now go create account<br>
                            BibleCoind account new<br><br>
                            If you already get account you can easily get list of all account created<br>
                            BibleCoind account list<br><br>
                            How to check balance ?<br>
                            BibleCoind console<br>
                            Now you are in BibleCoind console and paste<br>
                            web3.bible.getBalance(web3.bible.accounts[0])<br>
                            0 - represents first account<br><br>
                            Other useful things <a href="https://github.com/biblecoin/wiki/wiki/JavaScript-API" target="_blank">https://github.com/biblecoin/wiki/wiki/JavaScript-API</a>
                            <br><br><br><br>
                        </div><!--//row-->
                    </div>
                </div><!--//row-->
